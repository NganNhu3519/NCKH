...
% results.NMSE      = nmse_sparse;               % NMSE value
...
% % % 
% % % % Save to .mat file
% % % % save('D:\NCKH\Github\NCKH\Lorenz\Result\Sparse_results_v1.mat','results');
% save('D:\Thungan\Github\NCKH\Lorenz\Result\Sparse_results_v1.mat','results');
...
% 
% % --- Metrics ---
% plotData.NMSE    = nmse_sparse;               % chỉ số NMSE
% % % 
% % % % --- Parameters (optional) ---
% plotData.x0      = x0;                 
...
% 
% % % 
% % % save('D:\NCKH\Github\NCKH\Lorenz\Result\Result_Plot\Sparse_v1.mat','plotData');
% save('D:\Thungan\Github\NCKH\Lorenz\Result\Result_Plot\Sparse_v1.mat','plotData');
