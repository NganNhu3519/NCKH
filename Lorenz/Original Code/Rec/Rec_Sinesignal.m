...
%% Load WS-Inputv in
load D:\Thungan\Github\NCKH\Lorenz\Obs\y_sine.mat
load D:\Thungan\Github\NCKH\Lorenz\Result\Sine_results_v2.mat
...
subplot(212),plot(x,'LineWidth',5); hold on; plot(x1, 'r.','MarkerSize',8);...
